...
type VolumeSpec struct {
	...
	FsType    FSType `protobuf:"varint,3,opt,name=fs_type,enum=openstorage.api.FSType" json:"fs_type,omitempty"`
	...
	HALevel int32 `protobuf:"varint,5,opt,name=HALevel" json:"HALevel,omitempty"`
	// TODO(pedge): cos? volume_cos? VolumeCOS for enum name?
	Cos COS `protobuf:"varint,6,opt,name=cos,enum=openstorage.api.COS" json:"cos,omitempty"`
	// TODO(pege): dedupe?
...
func init() {
	...
	proto.RegisterEnum("openstorage.api.COS", COS_name, COS_value)
}
